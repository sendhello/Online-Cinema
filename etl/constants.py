...
extract_methods_by_modified_type = {
    StateName.FILM_WORK_LAST_MODIFIED: ['extract_updated_movies'],
    StateName.PERSON_LAST_MODIFIED: [
        'extract_movies_with_updated_people',
        'extract_updated_people',
    ],
    StateName.GENRE_LAST_MODIFIED: [
        'extract_movies_with_updated_genres',
        'extract_updated_genres',
    ],
}
