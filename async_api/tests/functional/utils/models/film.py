...
class EsFilm(EsModel):
    ...
    def create_fake(cls, **kwargs) -> Self:
        ...
        return cls(
            ...
            imdb_rating=kwargs.get(
                'imdb_rating', round(fake.pyfloat(min_value=0, max_value=100), 1)
            ),
            ...
            director=kwargs.get(
                'director',
                [fake.name() for _ in range(fake.pyint(min_value=1, max_value=3))],
            ),
            writers_names=kwargs.get(
            ...
            genre=kwargs.get(
                ...
                fake.random_elements(
                    elements=GENRES,
                    length=fake.pyint(min_value=1, max_value=3),
                    unique=True,
                ),
            ),
        )
