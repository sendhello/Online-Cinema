...
from core.event_mixins import EventLiveProbeMixin, LiveProbeStatus, ShutdownEventMixin, StartupEventMixin
...
class RabbitGateway(StartupEventMixin, ShutdownEventMixin, EventLiveProbeMixin):
    def __init__(self) -> None:
        self._dsn = rabbit_settings.rabbitmq_dsn
        self.prefetch_count = rabbit_settings.rabbitmq_prefetch_count
        self.exchange_type = rabbit_settings.rabbitmq_exchange_type
